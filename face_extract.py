# CACH DUNG LENH
# python face_extract.py --input D:/hatt6/video/train/train/Real/ --output dataset/real
# python face_extract.py --input D:/hatt6/video/train/train/Fake/ --output dataset/fake
        ...
        if len(detections) > 0:
            ...
            if confidence > args["confidence"]:
                ...
                p = os.path.sep.join([args["output"],
                                      video_name.split('/')[6] + "{}.png".format(saved)])
                print(p)
                cv2.imwrite(p, face)
                saved += 1
